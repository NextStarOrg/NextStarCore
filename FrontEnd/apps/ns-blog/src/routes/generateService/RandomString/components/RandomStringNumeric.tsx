...
const RandomStringNumeric = () => {
    ...
    const generateCore = (): string[] => {
        ...
        for (let i = 0; i < count; i++) {
            arr.push(CryptoRandomString({ length: len, type: "numeric" }));
        }
        return arr;
    };
            ...
            <Space direction={"vertical"}>
                <Typography.Paragraph>
                    ...
                    <Typography.Text keyboard>
                        {CryptoRandomStringCharacters.numericCharacters.join(
                            " "
                        )}
                    </Typography.Text>
                </Typography.Paragraph>
...
export default RandomStringNumeric;
