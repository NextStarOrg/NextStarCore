...
const RandomStringDistinguishable = () => {
    ...
    const generateCore = (): string[] => {
        ...
        for (let i = 0; i < count; i++) {
            arr.push(
                CryptoRandomString({ length: len, type: "distinguishable" })
            );
        }
        return arr;
    };
            ...
            <Space direction={"vertical"}>
                <Typography.Paragraph>
                    ...
                    <Typography.Text keyboard>
                        {CryptoRandomStringCharacters.distinguishableCharacters.join(
                            " "
                        )}
                    </Typography.Text>
                </Typography.Paragraph>
...
export default RandomStringDistinguishable;
